...
- [52](https://github.com/nf-core/references/pull/52) - Add readme, fasta_dict, bowtie1_index, bowtie2_index, bwamem1_index, bwamem2_index, dragmap_hashtable, star_index assets for files in igenomes
